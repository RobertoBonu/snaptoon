          ...
          <div>
            <label className="block text-sm font-medium mb-2">
              ...
              <span className="text-[var(--color-fg-muted)] text-xs">
                (max 6, opzionali — dai tuoi personaggi con reference AI)
              </span>
            </label>
            {myChars.length === 0 ? (
              <p className="text-sm text-[var(--color-fg-muted)] italic">
                Nessun personaggio con reference AI. Crea prima un personaggio
                in{" "}
                <a href="/app/my-characters" className="underline">
                  I miei Personaggi
                </a>
                .
              </p>
