...
def _build_card_prompt(
    *,
    ...
    return (
        ...
        "=== BOTTOM AREA (lower 20% of the card) ===\n"
        "Three yellow filled 5-point stars in a horizontal row centered "
        "(quality/collectibility indicator).\n"
        f"Below the stars, a BEIGE/TAN rounded rectangle panel with subtle "
        f"paper texture, containing the caption in bold italic serif "
        f"font, black or dark brown text: '{caption}'.\n"
        f"At the very bottom, a small BLUE rounded rectangle tag centered "
        f"with the progressive number in BOLD MONOSPACED font, white text: "
        f"'{number}'.\n\n"
